        ...
        return (
            <Fragment>
                <div>
                    ...
                    <Bar data={data} height={275} options={options} ref={(reference) => this.lineReference = reference} />
                </div>
            </Fragment>
        )
    }
...
export default connect(mapStateToProps, { getCondenserData })(RecordsBarChart)